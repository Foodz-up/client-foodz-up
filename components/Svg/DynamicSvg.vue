<template>
  <div v-if="componentName">
    <component :is="componentName" :width="width" />
  </div>
</template>
...
@Component({
  components: {
    ...
    deliver: () => import('~/components/Svg/SvgDeliver.vue'),
    favourite: () => import('~/components/Svg/SvgFavourite.vue'),
    ...
    cart: () => import('~/components/Svg/SvgCart.vue')
  }
})
